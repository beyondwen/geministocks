    ...
    <div className="bg-white border border-stone-200/90 rounded-2xl p-6 shadow-sm animate-reveal-up">
      <form onSubmit={handleSubmit}>
        <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-black">{t('qandaInput.title')}</h3>
              <p id="qanda-input-description" className="text-sm text-gray-600">
                {t('qandaInput.description')}
              </p>
            </div>
        </div>
