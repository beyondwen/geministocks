    ...
    return (
        <div className="mb-6">
            <a
                ...
                className={`flex items-center justify-center gap-x-2 text-center p-3 rounded-lg border ${bgClass} shadow-sm w-full max-w-sm mx-auto transition-all hover:shadow-md hover:border-cyan-400 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2`}
